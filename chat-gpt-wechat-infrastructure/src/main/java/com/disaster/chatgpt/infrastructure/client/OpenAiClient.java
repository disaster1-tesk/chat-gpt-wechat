package com.disaster.chatgpt.infrastructure.client;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.StrUtil;

import com.disaster.chatgpt.infrastructure.client.constant.OpenAIConst;
import com.disaster.chatgpt.infrastructure.client.entity.billing.BillingUsage;
import com.disaster.chatgpt.infrastructure.client.entity.billing.CreditGrantsResponse;
...
import com.disaster.chatgpt.infrastructure.client.entity.common.DeleteResponse;
import com.disaster.chatgpt.infrastructure.client.entity.common.OpenAiResponse;
import com.disaster.chatgpt.infrastructure.client.entity.completions.Completion;
import com.disaster.chatgpt.infrastructure.client.entity.completions.CompletionResponse;
import com.disaster.chatgpt.infrastructure.client.entity.edits.Edit;
import com.disaster.chatgpt.infrastructure.client.entity.edits.EditResponse;
import com.disaster.chatgpt.infrastructure.client.entity.embeddings.Embedding;
import com.disaster.chatgpt.infrastructure.client.entity.embeddings.EmbeddingResponse;
import com.disaster.chatgpt.infrastructure.client.entity.engines.Engine;
import com.disaster.chatgpt.infrastructure.client.entity.files.File;
import com.disaster.chatgpt.infrastructure.client.entity.files.UploadFileResponse;
import com.disaster.chatgpt.infrastructure.client.entity.fineTune.Event;
import com.disaster.chatgpt.infrastructure.client.entity.fineTune.FineTune;
import com.disaster.chatgpt.infrastructure.client.entity.fineTune.FineTuneDeleteResponse;
import com.disaster.chatgpt.infrastructure.client.entity.fineTune.FineTuneResponse;
import com.disaster.chatgpt.infrastructure.client.entity.images.*;
import com.disaster.chatgpt.infrastructure.client.entity.models.Model;
import com.disaster.chatgpt.infrastructure.client.entity.models.ModelResponse;
import com.disaster.chatgpt.infrastructure.client.entity.moderations.Moderation;
import com.disaster.chatgpt.infrastructure.client.entity.moderations.ModerationResponse;
import com.disaster.chatgpt.infrastructure.client.entity.whisper.Transcriptions;
import com.disaster.chatgpt.infrastructure.client.entity.whisper.Translations;
import com.disaster.chatgpt.infrastructure.client.entity.whisper.WhisperResponse;
import com.disaster.chatgpt.infrastructure.client.exception.BaseException;
import com.disaster.chatgpt.infrastructure.client.exception.CommonError;
...
public class OpenAiClient {
    ...
    public void buildOpenAiApi(){
        if (StrUtil.isBlank(this.apiHost)) {
            this.apiHost = OpenAIConst.OPENAI_HOST;
        }
        this.openAiApi = new Retrofit.Builder()
                .baseUrl(apiHost)
                .client(okHttpClient)
