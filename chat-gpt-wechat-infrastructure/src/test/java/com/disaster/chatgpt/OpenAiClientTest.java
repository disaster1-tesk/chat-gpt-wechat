...
import com.disaster.chatgpt.infrastructure.client.entity.whisper.Whisper;
...
import com.disaster.chatgpt.infrastructure.client.utils.TikTokensUtil;
...
public class OpenAiClientTest {
    ...
    public void before() {
        ...
        v2 = OpenAiClient.builder()
                //支持多key传入，请求时候随机选择
                .apiKey(Arrays.asList("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"))
                //自定义key的获取策略：默认KeyRandomStrategy
                //.keyStrategy(new KeyRandomStrategy())
                .keyStrategy(new FirstKeyStrategy())
                .okHttpClient(okHttpClient)
                //自己做了代理就传代理地址，没有可不不传,(关注公众号回复：openai ，获取免费的测试代理地址)
//                .apiHost("http://127.0.0.1:7890")
                .build();
    }
    @Test
...
//        Edit edit = Edit.builder().input("我爱你麻麻").instruction("帮我修改错别字").model(Edit.Model.TEXT_DAVINCI_EDIT_001.getName()).build();
    ...
    public void variationsImagesV2() {
        ...
        ImageResponse imageResponse = v2.variationsImages(new java.io.File("/Users/disaster/IdeaProjects/chat-gpt-wechat/chat-gpt-wechat-infrastructure/src/test/resources/man.png"), imageVariations);
        System.out.println(imageResponse);
    }
